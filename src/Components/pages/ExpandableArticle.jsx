...
export default function ExpandableArticle({
  ...
  if (loading) {
    return (
      <div className="w-full p-6 bg-white border border-gray-300 rounded-lg shadow-lg animate-pulse">
  ...
  return (
    <motion.div
      className="w-full p-6 bg-white border border-gray-300 rounded-lg shadow-lg"
